...
void GPS::configureUblox(byte *settingsArrayPointer) {
...
void GPS::printHex(uint8_t *data, uint8_t length) // prints 8-bit data in hex
{
  char tmp[length*2+1];
  byte first ;
  int j=0;
